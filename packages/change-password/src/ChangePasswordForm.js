...
const ChangePasswordForm = ({
  ...
  return (
    <BlockUI blocking={loading}>
      <Form initialValues={{ currentPassword: '', newPassword: '', confirmNewPassword: '' }} validationSchema={schema} onSubmit={handleSubmit}>
      <CardBody>
      {header}
      <Row>
      <Col>
      ...
      />
        ...
        <div className="password-with-icon">
          ...
          <Icon
            ...
            label="password-visibility"
            onMouseDown={e => {
              confirmPasswordIconRef?.current?.focus();
              e.preventDefault();
...
ChangePasswordForm.propTypes = {
  ...
  confirmPasswordProps: PropTypes.object,
};
