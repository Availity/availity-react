...
const ChangePassword = ({ resource, schema, conditions, children }) => {
    ...
    const confirmPasswordIconRef = useRef(null);
    ...
    return (
      <ChangePasswordContext.Provider value={{ loading, setLoading, error, setError, success, setSuccess, resource, schema, conditions, currentPasswordIconRef, newPasswordIconRef, confirmPasswordIconRef, currentPasswordVisible, setCurrentPasswordVisible, newPasswordVisible, setNewPasswordVisible, confirmNewPasswordVisible, setConfirmNewPasswordVisible }}>
      {children}
