...
export const Default = {
  render: ({ autofill, creatable, disabled, isMulti, max, min, raw, required }) => (
    <AvFormResults>
      <AvSelect
        name="standAlone"
        minLength={min}
...
export const WithLabel = {
  render: ({ autofill, creatable, disabled, errorMessage, isMulti, label, max, min, raw, required }) => (
    <AvFormResults>
      <AvGroup>
...
export const _AvResourceSelect = {
  render: ({ creatable, disabled, errorMessage, isMulti, label, max, min, required, requiredErrorMessage }) => (
    <AvFormResults>
      <AvResourceSelect
        label={
          <>
