...
Hook that allows asynchronous functions to be called in the standard `useEffect` React hook.

##### Arguments

- **`effect`**: The effect to call - just like the function given to `useEffect`.
