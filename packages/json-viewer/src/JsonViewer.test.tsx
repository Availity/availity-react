...
const setup = (data: Record<string, unknown>, expandAll?: boolean, listClassNames?: string | string[]) =>
  render(<JsonViewer data={data} expandAll={!!expandAll} listClassNames={listClassNames} />);
