...
const DisclaimerModal = ({ parentPayerSpaces, name, state: { selectedOption }, setState }) => (
  <ModalBody>
    <p>
        ...
        parentPayerSpaces.map((payerSpace) => (
          ...
          >
            <div className="link-payer-option">
              <CardImg width="100%" src={payerSpace.images.tile} alt={payerSpace.name} className="img-responsive" />
            </div>
          </Col>
        ))}
    </Row>
