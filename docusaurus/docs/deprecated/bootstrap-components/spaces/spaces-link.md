...
> NOTE: Using `<SpacesLink />` depends on [`@tanstack/react-query`](https://tanstack.com/query/latest)
...
When `true`, renders the `FavoriteHeart` component to the left of the Component. Note, this does require you to have wrapped your component somewhere in the `Favorites` Provider. This also requires the peerDependency [`@tanstack/react-query`](https://tanstack.com/query/latest).
