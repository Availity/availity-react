...
See [Feedback](/deprecated/bootstrap-components/feedback/feedback/#props). Props to send to `<Feedback />` component
...
Array of Objects containing `name` (String) and `url` (String) properties. The ancestor pages which get passed to the `Breadcrumbs` component. See [Breadcrumbs](/deprecated/bootstrap-components/breadcrumbs/#crumbs-object)
