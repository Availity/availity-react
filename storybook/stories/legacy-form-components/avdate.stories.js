...
export const _AvDateRange = () => {
  ...
  const defaultStartDate = hasDefaultStart && text('Default Start Date (yyyy-mm-dd)', '2019-01-01');
  const hasDefaultEnd = boolean('Has Default End Date', false);
  const defaultEndDate = hasDefaultEnd && text('Default End Date (yyyy-mm-dd)', '2019-12-31');
